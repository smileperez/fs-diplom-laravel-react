...
| 2.2 | В корне папки `/react` переименовываем имя конфиг-файла  `.env.example` на имя `.env` | Провеяем, что в файле указана константа `VITE_API_BASE_URL=http://localhost:8000` |
