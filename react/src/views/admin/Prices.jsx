...
export default function Halls() {
    ...
    return (
        <PageComponent title="Управление ценами">
            {loading && (
                <svg aria-hidden="true" className="mx-auto my-12 block w-20 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-violet-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
