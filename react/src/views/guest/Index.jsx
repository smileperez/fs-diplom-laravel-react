...
import NavBarComponent from "../../components/guest/NavBarComponent.jsx";
import { useEffect, useState } from "react";
import axiosClient from "../../axios.js";

// Функция конвертации нового объекта Date в формат YYYY-MM-DD
    ...
    return (
        <>
            ...
            <main>
                {loading && (
                    <>
                        <div className="py-44 mt-8 bg-[#F1EBE6] opacity-95 rounded">
